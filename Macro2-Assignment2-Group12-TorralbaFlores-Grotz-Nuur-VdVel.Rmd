...
ggplot() + 
  geom_line(DF_FR_NA, mapping = aes(x = date, y = GovDebt_ann_FR), color = "navyblue") +
  geom_line(DF_FR, mapping = aes(x = date, y = IntRate_quart_FR*10), color = "dodgerblue1") +
  scale_y_continuous(labels = scales::percent, name = "Government Debt France Annual in %", sec.axis = sec_axis(~ . * 10, name = "Long Term Interest Rate in %")) +
  labs(x = "Date", title = "Government Debt and Long Term Interest Rates\nFor France in %")
...
ggplot() + 
  geom_line(DF_FR, mapping = aes(x = date, y = CAasPercGDP_quart_FR), color = "navyblue") +
  geom_line(DF_FR, mapping = aes(x = date, y = XR_quart_EurUSD*10), color = "dodgerblue1") +
  scale_y_continuous(sec.axis = sec_axis(~ . / 10, name = "Exchange Rate - Eur/Dollar")) +
  labs(x = "Date", y = "CA as % of GDP", title = "CA as % of GDP and Exchange Rates\nFor France")
...
ggplot() + 
  ...
  labs(x = "Date", y = "Investment Rate and Savings Rate\nAs % of GDP", title = "Investment Rate and Savings as % of GDP\nFor France") +
