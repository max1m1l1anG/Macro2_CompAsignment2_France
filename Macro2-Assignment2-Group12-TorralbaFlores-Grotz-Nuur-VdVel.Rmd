...
ggplot() + 
  ...
  scale_y_continuous(labels = scales::percent, name = "Government Debt (annually in % of GDP)", sec.axis = sec_axis(~ . /10, name = "Long Term Interest Rate (quarterly in %)", labels = scales::percent)) +
...
ggplot() + 
  ...
  geom_line(DF_FR, mapping = aes(x = date, y = (XR_quart_EurUSD - .8 )/ 10, color = "Exchange Rate Eur/USD")) +
  scale_y_continuous(labels = scales::percent, limits = c(-0.04, 0.04), sec.axis = sec_axis(~ . *10 + .8, name = "Exchange Rate - Eur/Dollar")) +
