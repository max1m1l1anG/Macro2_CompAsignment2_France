...
ggplot() + 
  ...
  labs(x = "Year",
       y = "CA as % of GDP",
       title = "CA as % of GDP and Exchange Rates\nFor France",
       color = "") +
...
```
The current account and the exchange rate have both decreased and even though they fluctuate (e.g. due to changes in expectations), they do move together. Assuming relative price levels to be stable, if the euro appreciates, imports get more expensive, while exports become less competitive abroad, worsening the current account.


## 3. Relevant events and policy responses

The euro appreciated steadily in the early 2000s as it established itself as an international currency (Maggiori, Brent, & Schreger, 2019). This might, combined with France’s competitive weaknesses (International Monetary Fund. European Dept., 2013), have driven its deterioration of the current account. During the Great Recession government debt increased. Interest rates have declined due to a fall in inflation expectations and in the real interest rate (Claeys & Efstathiou, 2017). The latter and the sudden depreciation of the euro in 2015 were partly caused by the ECB’s quantitative easing program (Dedola, Georgiadis, Gräb, & Mehl, 2020).
...
The Feldstein-Horioka criterion states that free capital mobility should portray no strong correlation between investments and savings. In the graph above, it becomes clear that the puzzle does not hold and the correlation seems to be disappearing over time. 

Possible to add: This could be due to large trade imbalances or due to France becoming more integrated in the international capital market.

# References

Claeys, G., & Efstathiou, K. (2017). Is the recent increase in long-term
  interest rates a threat to euro-area recovery? *Bruegel Policy Contribution*
  (2017/14). Retrieved from http://hdl.handle.net/10419/173110
Dedola, L., Georgiadis, G., Gräb, J., & Mehl, A. (2020, October 20). Does a big 
  bazooka matter? Quantitative easing policies and exchange rates. 
  *Research Bulletin*, 76. Retrieved from
  https://www.ecb.europa.eu/pub/economic-research/resbull/2020/html/ecb.rb201020~85fb68a983.en.html
International Monetary Fund. European Dept. (2013, August 5). France: Selected 
  Issues paper. *IMF Staff Country Reports*, Volume 2013(Issue 252), 4-14.
  doi:https://doi.org/10.5089/9781484389133.002
Maggiori, M., Brent, N., & Schreger, J. (2019, May). The Rise of the Dollar and 
  Fall of the Euro as International Currencies. *AEA Papers and Proceedings*, 
  109, 521-526. doi:10.1257/pandp.20191007
