...
author: "Javier Torralba Flores (ANR: u146430, SNR: 2042878), Maximilian Grotz (ANR: u271366, SNR: 2056313), Abdirahman Nuur (ANR: u824009 , SNR: 2057152) and Mathieu  Van de Vel (ANR: u130770, SNR: 2050053)"
date: "14/04/2021"
output:
...
GDP_FR <- read_csv("sourcecode/FRED_euros_france_gdp_quarterly.csv", 
  ...
  mutate(date = DATE, DATE = NULL, GDP_quart_Millionseur_FR = CPMNACSCAB1GQFR, CPMNACSCAB1GQFR = NULL)
...
Invest_FR <- read_csv("sourcecode/FRED_euros_investments_quarterly.csv", 
  ...
  mutate(Invest_quart_Millionseur_FR = FRAGFCFQDSMEI / 1000000, FRAGFCFQDSMEI = NULL) %>%
  rename(date = DATE)
